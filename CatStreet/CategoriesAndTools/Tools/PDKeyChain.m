...
static NSString * const kPDDictionaryKey = @"com.zy.CatStreet.dictionaryKey";
static NSString * const kPDKeyChainKey = @"com.zy.CatStreet.keychainKey";
static NSString * const kPDKeyChainKey_LockPsw = @"com.zy.CatStreet.keychainKey_lockpsw";
...
+ (void)keyChainLockPswSave:(NSString *)string {
    NSMutableDictionary *tempDic = [NSMutableDictionary dictionary];
    [tempDic setObject:string forKey:kPDDictionaryKey];
    [self save:kPDKeyChainKey_LockPsw data:tempDic];
}

+ (NSString *)keyChainLockPswLoad{
    NSMutableDictionary *tempDic = (NSMutableDictionary *)[self load:kPDKeyChainKey_LockPsw];
    return [tempDic objectForKey:kPDDictionaryKey];
}
